...
public class RistinollaSovellus extends Application {
    ...
    public void start(Stage ikkuna) throws Exception {
        ...
        for (int i = 0; i < 9; i++) {
            if (i < 3) {
                ruudukko.add(napit.get(i), 0, i);
            } else if (i > 2 && i < 6) {
                ruudukko.add(napit.get(i), 1, i - 3);
            } else if (i > 5) {
                ruudukko.add(napit.get(i), 2, i - 6);
            }
        }
